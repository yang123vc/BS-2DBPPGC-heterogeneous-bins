...
bool TREE::local_eval(vector<NODE> &children, NODE &node, int types,
		double &ApzaMax) {
...
void KeepBestNodes(NODE &node_eval, vector<GE_COMP> &best_of,
		vector<int> &keep_id, vector<int>&no_pzas, int b) {
	if (best_of.empty()) {
		GE_COMP gg;
